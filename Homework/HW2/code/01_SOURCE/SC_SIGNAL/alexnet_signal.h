#ifndef ALEXNET_SIGNAL_H
#define ALEXNET_SIGNAL_H
...
// ============================================================
// AlexNet Top Module - sc_signal version
//
//   Connects Pattern <-> ModuleA -[sc_signal]-> ModuleB -[sc_signal]-> ModuleC
// ============================================================
SC_MODULE(AlexNet) {
    ...
    // --- Internal sc_signal channels ---
    sc_signal<FeatureMapSignal> sig_a_to_b;   // [64][27][27]
    sc_signal<bool>             sig_valid_ab;
    sc_signal<FlatSignal>       sig_b_to_c;   // [9216]
    sc_signal<bool>             sig_valid_bc;
